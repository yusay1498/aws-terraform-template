          ...
          "environment": [
              {
                  ...
                  "value": "${var.container_envvar_value_point_api_baseurl}"
              },
              {
                  "name": "SPRING_KAFKA_BOOTSTRAPSERVERS",
                  "value": "${var.container_envvar_value_kafka_bootstrap_servers}"
              },
              {
                  "name": "SPRING_KAFKA_TEMPLATE_DEFAULT_TOPIC",
                  "value": "${var.container_envvar_value_kafka_topic_name}"
              },
              {
                  "name": "SPRING_KAFKA_CONSUMER_GROUP_ID",
                  "value": "${var.container_envvar_value_kafka_consumer_group_id}"
              }
          ],
          "environmentFiles": [],
          "mountPoints": [],
